<template>
  <div class="flex items-center flex-shrink-0 p-4 pb-0">
    ...
    <div class="w-full p-2">
      <textarea
        v-model="text"
        class="w-full text-lg text-gray-900 placeholder-gray-400 dark:text-white dark:placeholder-gray-400 focus:ring-0 bg-inherit rounded-lg border-0"
  ...
  <div class="p-4 pl-16">
    <img
      ...
      :src="inputImgURL"
      v-if="inputImgURL"
      class="rounded-2xl border max-h-96"
      alt="" />
    <input
      accept="image/*"
      type="file"
  ...
  <div class="flex p-2 pl-14">
    <div class="flex w-full text-white">
      ...
      <div
        ...
        class="p-2 text-blue-400 rounded-full cursor-pointer hover:bg-blue-200 dark:hover:bg-dim-800">
      ...
      <div
        ...
        <svg viewBox="0 0 24 24" class="w-5 h-5" fill="currentColor">
          <g>
            ...
            <path
              d="M12 17.115c-1.892 0-3.633-.95-4.656-2.544-.224-.348-.123-.81.226-1.035.348-.226.812-.124 1.036.226.747 1.162 2.016 1.855 3.395 1.855s2.648-.693 3.396-1.854c.224-.35.688-.45 1.036-.225.35.224.45.688.226 1.036-1.025 1.594-2.766 2.545-4.658 2.545z"></path>
    ...
    <div class="ml-auto">
      <UIButton :disabled="isDisabled" size="sm" @click="handleFormSubmit">
...
<script setup>
  ...
  const handleImageChange = e => {
    ...
    reader.onload = e => {
      inputImgURL.value = e.target.result;
    };
